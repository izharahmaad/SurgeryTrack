...
const staffRoles: RoleOption[] = [
  {
    ...
    subtitle: 'Manage surgeries and patient updates',
    icon: 'doctor',
  },
  {
    id: 'nurse',
    title: 'Nurse',
    subtitle: 'Assist in surgery monitoring',
    icon: 'needle',
  },
  {
    id: 'receptionist',
  ...
  },
  {
    ...
    subtitle: 'Full hospital management access',
    icon: 'shield-account',
  },
];
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>
            Choose your position at the hospital
          </Text>
        </View>
